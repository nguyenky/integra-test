...
require_once(__DIR__ . '/../libraries/MWSSubscriptionsService/Model/UpdateSubscriptionInput.php');
...
class AmazonUpdateSubscription extends Command
{
	protected $name = 'amazon:updateSubscription';
    ...
    public function fire() {
    	Log::info("================ Update subscription ". date('Y-m-d H:i:s') ." ==============");
    	...
    	$this->invokeUpdateSubscription($service, $request);
    	...
    	/**
    	  ...
    	  */
	function invokeUpdateSubscription(MWSSubscriptionsService_Interface $service, $request) {
	    try {
