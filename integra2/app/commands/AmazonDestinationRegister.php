...
require_once(__DIR__ . '/../libraries/MWSSubscriptionsService/Model/RegisterDestinationInput.php');
...
class AmazonDestinationRegister extends Command
{
	protected $name = 'amazon:registerDestination';
    protected $description = 'Register Destination data';
    ...
    public function fire() {
    	Log::info("================ Register Destination ". date('Y-m-d H:i:s') ." ==============");
