               ...
               .success(function(response)
                { 
                   ...
                   {                   
                      ...
                      var kit_qty = 1; // obj.kit_quantity = 0 ? 1:obj.kit_quantity;
                      
                      if(obj.kit_quantity > 0)
                      {                         
                         kit_qty = obj.kit_quantity;
                         console.log('kit_qty_here'+kit_qty);
                      }
                      ...
                      console.log('Wobj:'+obj.content.item.weight); 
                      console.log('W:'+weight);

                   }); //end second foreach  
                       
                     
                     console.log('1.weight:'+weight)
