                  ...
                  var sales_price = 0;
                   ...
                   .success(function(data) {                   
                    ...
                    this.responseData =  {
                        ...
                        var n1 = ((profit/100)*cost) + (cost+shipping_rate);
                        sales_price = (n1 / 0.88);                      
                        ...
                        $scope.items[index].sales_price = sales_price.toFixed(2);
                           ...
                           .success(function(data) {                   
                              ...
                              //  var n1_total = ( ($scope.totalProfit/100) * ($scope.totalCost) + ($scope.totalCost) + (core_charge*$scope.totalQuantity) +  $scope.totalShipping);
                                 var n1 = (($scope.totalProfit/100)*$scope.totalCost) + ($scope.totalCost+$scope.totalShipping);                              
                                total_sales_price = (n1_total / 0.88);    
