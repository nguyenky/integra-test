				 ...
				 <div class="col-md-3">
	                  ...
	                  <div class="panel panel-default">
						   <div class="panel-body ">
						    <h4 class="text-primary">
						      ...
						      <h6> <small> ((TOTAL PROFIT % /100)* ( TOTAL COST* TOTAL QTY) + (TOTAL COST* TOTAL QTY) + (Core Charge*TOTAL QTY) + TOTAL SHIPPING ) / 0.93  </small></p>
						    </h4>
				  ...
				  <table class="table">
				    <tr>
				   	  ...
				   	  <td class="text-danger"><h6><b>Sales Price</b> <small>((PROFIT % /100)* (COST*QTY) + (COST*QTY) + (Core Charge*QTY) + SHIPPING ) / 0.936</small></h6>
				   	  <td width="5%">
