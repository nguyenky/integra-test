...
?>
	...
	var chart = new google.visualization.LineChart(document.getElementById('amazon_daily'));
...
?>
	...
	var chart = new google.visualization.LineChart(document.getElementById('amazon_weekly'));
...
?>
	...
	var chart = new google.visualization.LineChart(document.getElementById('amazon_monthly'));
...
<body>
<div class='chart' id='amazon_daily'></div>
<div class='chart' id='amazon_weekly'></div>
<div class='chart' id='amazon_monthly'></div>
</body>
</html>
