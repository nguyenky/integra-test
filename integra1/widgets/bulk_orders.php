...
$q = <<<EOQ
SELECT ds.order_id, COUNT(*), SUM(IF(o.status != 4 AND o.status != 90, 1, 0)), DATE_FORMAT(ds.order_date, '%m-%d'), ds.tracking_num, DATE_FORMAT(IFNULL(o.etd, ds.etd), '%m-%d'), CONCAT('W', ds.supplier), is_delivered
